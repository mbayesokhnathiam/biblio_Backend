...
class CommentaireController extends BaseController
{
     ...
     *
     * @param  CommentaireRepository  $users
     * @return void
     */
    public function __construct(CommentaireService $service)
    {
    ...
    public function index()
    {
        ...
        public function store(CommentaireRequest $request)
        {
            try
            {
                ...
                return $this->sendError("Une erreur est survenue de de l'ajout de: commentaire , Veuiller contacter l'administrateur"   );
            }
        }
