...
class AbonneController extends BaseController
{
     ...
     *
     * @param  AbonneRepository  $users
     * @return void
     */
    public function __construct(AbonneService $service)
    {
    ...
    public function index()
    {
        ...
        public function store(AbonneRequest $request)
        {
            try
            {
                ...
                return $this->sendError("Une erreur est survenue de de l'ajout de: abonne , Veuiller contacter l'administrateur"   );
            }
        }
